...
public class SemanticTest {
	...
	private void verificaCodigoGerado(String programaFonte, String codigoObjetoEsperado)
	...
	public void testDeclaraIntSetaValorPositivado() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", "ldc.i8 1", "stloc i_primeiro" };
	...
	public void testDeclaraIntSetaValorNegativado() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", "ldc.i8 1", "ldc.i8 -1", "mul",
				"stloc i_primeiro" };
	...
	public void testDeclaraFloatSetaValorNegativado() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (float64 f_primeiro)", "ldc.r8 1.0", "ldc.i8 -1", "mul",
				"stloc f_primeiro" };
	...
	public void testSomaConstantes() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", "ldc.i8 1", "ldc.i8 2", "add",
				"stloc i_primeiro" };
	...
	public void testSomaVariaveis() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", ".locals (int64 i_segundo)", "ldc.i8 1",
				"stloc i_primeiro", "ldloc i_primeiro", "ldloc i_primeiro", "add", "stloc i_segundo" };
	...
	public void testSomaIntComFloat() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (float64 f_primeiro)", "ldc.i8 1", "ldc.r8 2.5", "add",
				"stloc f_primeiro" };
	...
	public void testSubtraiConstantes() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", "ldc.i8 1", "ldc.i8 2", "sub",
				"stloc i_primeiro" };
	...
	public void testMultiplicaConstantes() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (int64 i_primeiro)", "ldc.i8 1", "ldc.i8 2", "mul",
				"stloc i_primeiro" };
	...
	public void testDivideConstantes() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (float64 f_primeiro)", "ldc.i8 1", "ldc.i8 2", "div",
				"stloc f_primeiro" };
	...
	public void testDivideTiposDiferentes() throws LexicalError, SyntaticError, SemanticError {
		...
		String[] codigoObjeto = new String[] { ".locals (float64 f_primeiro)", "ldc.i8 1", "ldc.r8 2.5", "div",
				"stloc f_primeiro" };
